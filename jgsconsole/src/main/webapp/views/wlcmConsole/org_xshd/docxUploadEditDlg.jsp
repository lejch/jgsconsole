...
<script type="text/javascript" src="${ctx}/static/bootstrap_fileupload/js/fileinputDocx.js"></script>
<style>a{text-decoration:none;}</style>
<div class="container kv-main" style="width:99%;margin-top:10px;">
	<form enctype="multipart/form-data">
         <div class="form-group">
             <input id="file" name="file" class="file" type="file" multiple data-upload-url="${ctx}/HpwlNews/docxUpload2">
         </div>
     </form>
</div>
