...
<html>
  <head>
	...
	<script type="text/javascript">
		var NEWS_TYPE='2';
		var NEWS_TITLE='学术活动';
		var NEWS_ADD_BTN='#addXshd';
		var NEWS_FOLDER='org_xshd';
	</script>
  </head>
<body>
<div style="border-radius:6px;flex-direction: column;overflow:hidden;box-shadow: 0 1px 2px 0 rgba(0,0,0,0.5);margin-left: 2px;margin-right:2px;margin-top: 2px;">
  	...
  	<span style="display:inline-block;font-size:20px;font-weight:bold;padding-left:20px;margin-top:10px;">学术活动</span>
	   <div class="btn-group btn-group-sm" role="group" style="float:right;padding:5px 20px 5px 0px;height:32px;">
	   		<shiro:hasPermission name="xshdAdd">
	   			...
	   			<button id='addXshd' type="button" class="btn btn-default btn-xs btn_plugin_style" onmouseleave="delBtnTips()" onmouseenter="initBtnTips2(this)">
