...
<html>
  <head>
	...
	<script type="text/javascript" src="${ctx}/views/wlcmConsole/org_member/memberReg.js"></script>
	<style type="text/css">
		 .datagrid-body{overflow-x:hidden !important;}
		 .btn_plugin_style{padding:4px 5px 4px 7px;text-align:center !important;}
...
<div style="border-radius:6px;flex-direction: column;overflow:hidden;box-shadow: 0 1px 2px 0 rgba(0,0,0,0.5);margin-left: 2px;margin-right:2px;margin-top: 2px;">
  	...
  	<span style="display:inline-block;font-size:20px;font-weight:bold;padding-left:20px;margin-top:10px;">个人会员及理事申请信息</span>
  	<i class="glyphicon glyphicon-info-sign" style="font-size:16px;cursor:pointer;" id="xmtips"></i>
	   <div class="btn-group btn-group-sm" role="group" style="float:right;padding:5px 20px 5px 0px;height:32px;">
	   		<shiro:hasPermission name="groupRegExport">
	   			<button id='exportAllGroupReg' type="button" style="margin-right:10px;border-radius:3px !important;padding:0px 9px !important;" onmouseleave="delBtnTips()" onmouseenter="initBtnTips6(this)" class="btn btn-default btn-xs btn_plugin_style">
	   				<i class="LigatureSymbols LigatureSymbolsLsh" style="font-size:21px;"></i>
	   			</button>
			</shiro:hasPermission>
	   		<shiro:hasPermission name="memberRegExport">
	   			<button id='exportAllMemberReg' type="button" style="margin-right:10px;border-radius:3px !important;padding:0px 8px !important;" onmouseleave="delBtnTips()" onmouseenter="initBtnTips2(this)" class="btn btn-default btn-xs btn_plugin_style">
	   				<i class="LigatureSymbols LigatureSymbolsUser" style="font-size:21px;"></i>
	   			</button>
			</shiro:hasPermission>
			<button id="searchBoxBtnCnt" type="button" class="btn btn-default btn-xs" style="padding:4px;">
   				...
   				<div id="mm">
					...
					<div data-options="name:'2'">姓名</div>
					<div data-options="name:'3'">手机号</div>
					<div data-options="name:'4'">e-mail</div>
					<div data-options="name:'5'">申请账号名</div>
				</div>
	   		</button>
	   </div>
	 </div>
