...
<html>
  <head>
	...
	<script type="text/javascript" src="${ctx}/views/wlcmConsole/org_menu/menuMaintenance.js"></script>
	<style type="text/css">
...
<div style="border-radius:6px;flex-direction: column;overflow:hidden;box-shadow: 0 1px 2px 0 rgba(0,0,0,0.5);margin-left: 2px;margin-right:2px;margin-top: 2px;">
  	...
  	<span style="display:inline-block;font-size:20px;font-weight:bold;padding-left:20px;margin-top:10px;">网站菜单配置</span>
	   <div id="userToolBars" class="btn-group btn-group-sm" role="group" style="float:right;padding:5px 10px 5px 0px;">
	   		<shiro:hasPermission name="orgMenuAdd">
			...
			<shiro:hasPermission name="orgMenuEdit">
			...
			<shiro:hasPermission name="orgMenuDel">
			...
			<shiro:hasPermission name="orgMenuInUse">
