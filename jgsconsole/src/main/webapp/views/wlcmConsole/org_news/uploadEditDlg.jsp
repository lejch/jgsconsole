...
<script type="text/javascript" src="${ctx}/static/bootstrap_fileupload/js/fileinput.js"></script>
<style>a{
...
<div class="container kv-main" style="width:99%;">
	<form enctype="multipart/form-data">
         <div class="form-group">
             <input id="file" name="file" class="file" type="file" multiple data-preview-file-type="any" data-upload-url="${ctx}/HpwlNews/fileUpload">
         </div>
     </form>
</div>
