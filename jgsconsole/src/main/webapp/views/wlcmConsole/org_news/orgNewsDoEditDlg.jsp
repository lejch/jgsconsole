...
<script type="text/javascript" src="${ctx}/views/wlcmConsole/org_news/orgNewsDoEditDlg.js"></script>
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		...
		<form id="orgNewsEditForm" method="post">
			...
			<table style="margin-top:5px;margin-left:10px;">
				 <tr>
				    <th>标题</th>
					<td><input name="TITLE" id="TITLE" style="width:563px;" required="required" class="easyui-textbox easyui-validatebox" type="text"/></td>
				</tr>
			</table>
		...
		<script type="text/plain" id="anoumeditor"></script>
