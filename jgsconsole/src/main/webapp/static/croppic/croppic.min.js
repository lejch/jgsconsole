(function (window, document) {
	...
	Croppic.prototype = {
		...
		createCropControls: function(){
			...
			html =  '<div class="cropControls cropControlsCrop" style="top:-31px !important;">'+ cropControlZoomMuchIn + cropControlZoomIn + cropControlZoomOut + cropControlZoomMuchOut + cropControlRotateLeft + cropControlRotateRight + cropControlCrop + cropControlReset + '</div>';
